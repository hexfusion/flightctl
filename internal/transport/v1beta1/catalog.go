...
func (h *TransportHandler) CreateCatalog(w http.ResponseWriter, r *http.Request) {
	var catalog apiv1beta1.Catalog
...
// (GET /api/v1/catalogs)
func (h *TransportHandler) ListCatalogs(w http.ResponseWriter, r *http.Request, params apiv1beta1.ListCatalogsParams) {
...
func (h *TransportHandler) ListCatalogItems(w http.ResponseWriter, r *http.Request, name string, params apiv1beta1.ListCatalogItemsParams) {
